export { isDevToolsOpen, isLikelyEmulated } from './detect-emulation.util';
export { getExtensionContext } from './extension-context.util';
export { parseUserAgent } from './user-agent.util';
export { getBrowserZoomLevel } from './zoom-level.util';
